...
# The masking approach used in this code is taken from the link
#     https://github.com/Knoxville-FRC-alliance/Vision-2018-Python/blob/master/vision.py
#
# However, it does not really work well because the mask is based on thresholding the green component
# of the RGB image. Using an RGB image does not seem good because pure white has a full green component
# and thus white is not filtered out. 
